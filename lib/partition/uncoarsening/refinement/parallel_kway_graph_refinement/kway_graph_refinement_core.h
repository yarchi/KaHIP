...
public:
        ...
        std::tuple<EdgeWeight, int, int, uint32_t> single_kway_refinement_round(thread_data_refinement_core& td);
...
private:
        ...
        std::unordered_map<int, std::vector<std::pair<int, int>>> hist;
        std::unordered_map<int, std::vector<std::pair<int, int>>> hist_neighbours;
        ...
        single_kway_refinement_round_internal(thread_data_refinement_core& td);
        ...
        EdgeWeight apply_moves(thread_data_refinement_core& config,
                               moved_nodes_hash_map& moved_nodes,
                               bool compute_touched_partitions,
                               std::unordered_map <PartitionID, PartitionID>& touched_blocks) const;
